odoo.define('comceptplus_message_readers.chat_manager', function (require) {
"use strict";
...
console.log('BEGINING of override (ChatManager.make_message)');


ChatManager.add_channel_to_message = function(message, channel_id) {
...
ChatManager.make_message = function(data)
{
    ...
    function property_descr(channel) {
        return {
            ...
            set: function (bool) {
                if (bool) {
                    // add_channel_to_message >>> ChatManager.add_channel_to_message
                    ChatManager.add_channel_to_message(msg, channel);
                } else {
    ...
    if (msg.model === 'mail.channel') {
        ...
        var channel = origin && ChatManager.get_channel(origin);
        if (channel) {
...
console.log('END of override (ChatManager.make_message)');
